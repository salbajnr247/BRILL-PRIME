...
class AddNewCommodityScreen extends StatefulWidget {
  const AddNewCommodityScreen({super.key});
  @override
  State<AddNewCommodityScreen> createState() => _AddNewCommodityScreenState();
}

class _AddNewCommodityScreenState extends State<AddNewCommodityScreen> {
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        authProvider.onboardingVendor || uploadingImage
                                            ...
                                            if (commodityPicture == null) {
                                              ...
                                              if (imageUrl != null) {
                                                ...
                                                final commodityAdded =
                                                    await vendorProvider.addCommodity(
                                                        context: context,
                                                        commodityName:
                                                            nameOfItemController
                                                                .text,
                                                ...
                                                customSnackBar(context,
                                                    'Unable to upload commodity image');
                                              }
                                            }
                                          },
