import 'dart:async';
import 'package:brill_prime/ui/forgot_password_flow/set_new_password_screen.dart';
...
class VerifyEmailToChangeScreen extends StatefulWidget {
  const VerifyEmailToChangeScreen({super.key});

  @override
  State<VerifyEmailToChangeScreen> createState() =>
      _VerifyEmailToChangeScreenState();
}

class _VerifyEmailToChangeScreenState extends State<VerifyEmailToChangeScreen> {
                    ...
                    child: Column(
                      children: [
                        ...
                        BodyTextLightWithLineHeight(
                          text:
                              authProvider.emailForPasswordReset.toLowerCase(),
                            ...
                            : MainButton(
                                ...
                                () async {
                                  if (otpController.text
                                          ...
                                          6 &&
                                      !authProvider.isVerifyingOTP) {
                                    final emailVerified = await authProvider
